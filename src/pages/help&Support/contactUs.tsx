...
import ContactModal from "./needhelp/contactModal";
...
const ContactUs = () => {
  ...
  const [categoryId, setCategoryId] = useState(data[0].catId);

  useEffect(() => {
    setCategoryId(data[0].catId);
  }, []);
 ...
 const  skeletonLoader  = useSelector((state: ReducersModal) => {
  ...
  const getQuestions = () => {
    dispatch(
      getHelpSupportQues(`?type=questions&catId=${categoryId}`, (resp: any) => {
      ...
      <div className={classes.innerDiv}>
        ...
        {skeletonLoader ? (
          ...
          <Typography variant="body1" className={classes.para}>
            Lorum ipsum dollar gotchs ipsum dolllar gotcha
          </Typography>
        )}
